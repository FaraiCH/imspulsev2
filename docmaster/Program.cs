...
using docmaster.Configuration;
using docmaster.Service;

Syncfusion.Licensing.SyncfusionLicenseProvider.RegisterLicense("NTQ3OTExQDMyMzAyZTMzMmUzMGh0VkNZWkEwTXhFalZMRDNRbDBvcTVPeGpSR0k4bFFJNHorV29vcUhSbVE9");
